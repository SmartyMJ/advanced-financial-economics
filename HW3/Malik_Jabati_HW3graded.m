%Comments:
% you do a really great job of explaining why the market would react to NFPs in your discussion
% really strong detail in there
% but you are not thinking of the currencies as a cross: eur/us,  gbp/usd, usd/cad
% the crosses are not all consistent so you cannot just compare
% like you are for example, the canadian the us dollar is in the numerator while for euro it is in the denominator
% so while you say it has the smallest car, it may be bigger if you adjusted to compare it to the rest
